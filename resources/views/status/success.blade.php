...
<div class="max-w-md w-full  p-8 rounded mx-auto">
    ...
    <div class="text-center flex justify-center mb-8">
      <img src="{{asset('successful.png')}}" width="300">

    </div>
    <div class="text-center  justify-center mb-8">
    <h2 class="text-xl font-semibold text-gray-800">شكرا لك ، تمت عملية الدفع بنجاح</h2>
    <p class="text-gray-600 mb-10">سوف يتم ارسال ايميل بالبريد الالكتروني الخاص بك فور اطلاق الكورس</p>
